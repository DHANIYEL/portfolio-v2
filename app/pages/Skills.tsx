...
const Skills = () => {
  ...
  return (
    <section className="relative min-h-screen w-full text-white px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-20 md:py-24 lg:py-32 flex items-center justify-center overflow-hidden">
